<x-app-layout> <x-slot name="header"> <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
    {{ __('Audio Management') }} </h2> </x-slot>
    <div class="py-6"> <div class="w-full mx-auto sm:px-6 lg:px-8"> <div class="bg-black dark:bg-gray-800
        ...
        <div class="overflow-x-auto bg-black rounded-lg shadow overflow-y-auto relative" style="height: 405px;"> <table
        ...
        dark:bg-gray-900">Action</th>
            ...
            <td class="border-dashed border-t border-gray-200 dark:border-gray-800 px-3 py-2">
                ...
                <td class="border-dashed border-t border-gray-200 dark:border-gray-800 px-3 py-2">{{ $song->title
                }}</td>
                <td class="border-dashed border-t border-gray-200 dark:border-gray-800 px-3 py-2">{{ $song->genres
                }}</td>
